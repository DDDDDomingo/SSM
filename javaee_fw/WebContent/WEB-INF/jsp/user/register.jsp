			...
			<div class="col-md-12" style="background-image: url(images/background.jpg);">
				<div class="row" style="margin-bottom: 20px;">
					...
					<div class="col-md-5"
						...
						<form role="form" style="margin-top: 20px;" action="<%=basePath%>user/registerOn">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="exampleInputPassword1" name="userAccount" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" id="exampleInputPassword1" name="userPwd2" />
							</div>
							<div class="form-group">

								<label for="exampleInputPassword1"> 手机 </label>
								<input type="text" class="form-control" id="exampleInputPassword1" name="userTel" />
							</div>
							<div class="form-group">

								<label for="exampleInputPassword1"> 姓名 </label>
								<input type="text" class="form-control" id="exampleInputPassword1" name="userRealname" />
							</div>
							<div class="form-group">

								<label for="exampleInputPassword1"> 性别 </label>
								<input type="text" class="form-control" id="exampleInputPassword1" name="userSex" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="exampleInputPassword1" name="userQq" />
							</div>
							<div class="form-group">
								<button type="submit" class="btn btn-default"
									style="width: 365px; margin-top: 20px; background-color: #B22222; color: white; margin-left: 200px;">
									注册</button>
									
								<a href="user/login"><button type="button" class="btn btn-default"
									style="width: 365px; margin-top: 20px; background-color: #B22222; color: white; margin-left: 200px;">
									返回</button></a>
							</div>
						</form>
