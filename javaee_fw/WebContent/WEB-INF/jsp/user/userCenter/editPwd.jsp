	...
	<div class="container">
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<form role="form" action="<%=basePath%>user/editPwdCheck">
					<input type="text" name="userId" value="${userInfo1.userId }" style="display:none">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="userPwd" placeholder="请输入原密码">
						</div>
						<div class="form-group">
							<label for="userPwd1">新密码</label>
							<input type="text" class="form-control" name="userPwd1" placeholder="请输新密码">
						</div>
