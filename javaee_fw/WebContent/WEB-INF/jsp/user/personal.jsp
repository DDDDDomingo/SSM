		...
		<div class="row">
			...
			<div class="col-sm-9 col-md-9" style="margin-bottom: 40px;">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-2">
							<img alt="Bootstrap Image Preview" src="<%=basePath%>${userInfo1.userAvatar}"
								class="img-circle" style="height: 100px; width: 100px;" />
						</div>
						<div class="col-md-10">
							<div class="list-group">
								<a href="#" class="list-group-item active"
									style="background-color: #B22222; border-color: #B22222">用户名</a>
								<div class="list-group-item">${userInfo1.userName}</div>

							</div>
							<div class="list-group">
								<a href="#" class="list-group-item active"
									style="background-color: #B22222; border-color: #B22222">账号</a>
								<div class="list-group-item">${userInfo1.userAccount}</div>

							</div>
							<div class="list-group">
								<a href="#" class="list-group-item active"
									style="background-color: #B22222; border-color: #B22222">联系电话</a>
								<div class="list-group-item">${userInfo1.userTel}</div>

							</div>
							<div class="list-group">
								<a href="#" class="list-group-item active"
									style="background-color: #B22222; border-color: #B22222">性别</a>
								<div class="list-group-item">${userInfo1.userSex}</div>

							</div>
							<div class="list-group">
								<a href="#" class="list-group-item active"
									style="background-color: #B22222; border-color: #B22222">邮箱</a>
								<div class="list-group-item">${userInfo1.userEmail}</div>

							</div>
							<div class="list-group">
								<a href="#" class="list-group-item active"
									style="background-color: #B22222; border-color: #B22222">QQ</a>
								<div class="list-group-item">${userInfo1.userQq}</div>
