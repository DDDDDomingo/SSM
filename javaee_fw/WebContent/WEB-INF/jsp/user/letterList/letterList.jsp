				...
				<div class="container-fluid">
					<div class="row">
						<c:if test="${!empty letterList}">
							<c:forEach items="${letterList}" var="ll" varStatus="vs">
								<div class="col-md-12">
									<div class="list-group">
										<h4 class="list-group-item active"
											style="background-color: #B22222; border-color: #B22222">发件人昵称：${ll.senderName}</h4>
										<div class="list-group-item">发信时间:&nbsp;&nbsp;&nbsp;&nbsp;${ll.plusTime}</div>
										<div class="list-group-item">商品名：<a href="front/singleGood?saleId=${ll.letterState }"><c:out value="${ll.letterStateName}" /></a></div>
										<div class="list-group-item" style="height: 200px;">
											<h4 class="list-group-item-heading">${ll.letterContent}</h4>
										</div>
										<div class="list-group-item">
											<a href="saleList/confirmSale?saleId=${ll.letterState}&userId=${ll.recieverId}&buyerId=${ll.senderId}"><button type="submit" class="btn btn-default">确认交易</button></a>
											<a href="saleList/delMessage?id=${ll.letterId}&userId=${ll.recieverId}"><button type="submit" class="btn btn-danger">删除</button></a>
										</div>
									</div>
								</div>
							</c:forEach>
