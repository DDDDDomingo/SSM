	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9" style="margin-bottom: 40px;">
				...
				<div class="row">
					<div class="col-md-12">
						<form role="form" action="<%=basePath%>saleList/editWishListCheck">
							<input type="text" name="userId" value="${wishlistInfo.userId}" style="display:none">
							<input type="text" name="wlistState" value="${wishlistInfo.wlistState}" style="display:none">
							<input type="text" name="wlistId" value="${wishlistInfo.wlistId}" style="display:none">
							<div class="form-group">
								<label for="inputFile"> 商品图片选择 </label>
								<div class="pic" style="margin-top: 10px; margin-bottom: 10px;">
									<img src="<%=basePath%>${wishlistInfo.wlistImg}" style="height: 150px; width: 150px;">
								</div>
								<input type="file" id="inputfile" name="wlistImg">
								<p class="help-block"></p>
							</div>
							<div class="form-group">
								<label for="wlistName">商品名</label>
								<input type="text" class="form-control" name="wlistName" value="${wishlistInfo.wlistName}">
							</div>
							<div class="form-group">
								<label for="wishCataName">商品类别</label>
								<select class="form-control" name="wishCataName">
							...
							<div class="form-group">
								<label for="wlistContent">文本框</label>
								<textarea id="editContent" class="form-control" rows="10" name="wlistContent"></textarea>
							</div>
