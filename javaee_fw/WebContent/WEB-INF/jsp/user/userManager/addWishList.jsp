	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9" style="margin-bottom: 40px;">
				...
				<div class="row">
					<div class="col-md-12">
						<form role="form" action="<%=basePath%>saleList/addWishListCheck">
							<input type="text" style="display:none" name="userId" value="${userInfo1.userId}">
							...
							<div class="form-group">
								<label for="wlistName"> 求购商品名 </label>
								<input type="text" class="form-control" name="wlistName" placeholder="请输入商品名" />
							</div>
							<div class="form-group">
								<label for="wishCataName"> 求购商品类别 </label>
								<select class="form-control" name="wishCataName">
									<c:forEach items="${cateList}" var="ci" varStatus="vs">
										<option>
											<c:out value="${ci.categoryType}" />
										</option>
									</c:forEach>
								</select>
							</div>
							<div class="form-group">
								<label for="wlistContent"> 商品描述 </label>
								<textarea class="form-control" rows="10" name="wlistContent" placeholder="请输入商品描述"></textarea>
							</div>
