	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9" style="margin-bottom: 40px;">
				...
				<div class="row">
					<div class="col-md-12">
						<form role="form" action="<%=basePath%>saleList/addSaleListCheck">
							...
							<div class="form-group">
								...
								<input type="file" id="exampleInputFile" name="saleImg" />
							</div>

							<div class="form-group">
								<label for="saleName"> 商品名 </label>
								<input type="text" class="form-control" id="exampleInputEmail1" name="saleName" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="salePrice" placeholder="请输入商品价格">
							</div>
							<div class="form-group">
								<label for="saleReserve">商品数量</label>
								<input type="text" class="form-control" name="saleReserve" placeholder="请输入商品数量">
								<p class="help-block">这里是块级帮助文本的实例。</p>
							</div>
							<div class="form-group">
								<label for="saleContent">文本框</label>
								<textarea class="form-control" rows="10" name="saleContent" placeholder="请输入商品描述"></textarea>
							</div>
