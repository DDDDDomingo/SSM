	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-9 col-md-9" style="margin-bottom: 40px;">
				...
				<div class="row">
					<div class="col-md-12">
						<form role="form" action="<%=basePath%>saleList/editSaleListCheck">
							<input type="text" name="userId" value="${salelistInfo.userId}" style="display:none">
							<input type="text" name="saleState" value="${salelistInfo.saleState}" style="display:none">
							<input type="text" name="saleId" value="${salelistInfo.saleId}" style="display:none">
							<div class="form-group">
								<label for="exampleInputFile"> 商品图片编辑 </label>
								<div class="pic" style="margin-top: 10px; margin-bottom: 10px;">
									<img src="<%=basePath%>${salelistInfo.saleImg}" style="height: 150px; width: 150px;">
									<input type="file" id="inputfile" name="saleImg" />
								</div>
							</div>
							<div class="form-group">
								<label for="saleName">商品名</label>
								<input type="text" class="form-control" name="saleName" value="${salelistInfo.saleName}">
							</div>
							<div class="form-group">
								<label for="saleCataName">商品类别</label>
								<select class="form-control" name="saleCataName">
									<c:forEach items="${cateList}" var="ci" varStatus="vs">
										<option><c:out value="${ci.categoryType}" /></option>
									</c:forEach>
								</select>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="salePrice" value="${salelistInfo.salePrice}">
							</div>
							<div class="form-group">
								<label for="saleReserve">商品数量</label>
								<input type="text" class="form-control" name="saleReserve"
									value="${salelistInfo.saleReserve}">
							</div>
							<div class="form-group">
								<label for="saleContent">文本框</label>
								<textarea id="editContent" class="form-control" rows="10" name="saleContent"></textarea>
							</div>
							<button type="submit" class="btn btn-default">提交</button>
							<button type="button" class="btn btn-default">
								<a href="saleList/myList?id=${userInfo1.userId}">返回</a>
							</button>
